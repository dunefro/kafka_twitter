...
Phase Alpha 2.0.0 -> Consuming the tweet details and putting them in elasticsearch.
            ...
            2.0.2 -> Adding header list along with the tweets. Header list include
                A) For tweets ->  Tweet ID, Hashtags, User with Name and ID, Mentions with Name and ID, timestamp
                B) For Retweets -> Tweet ID, Retweet ID, Hashtags, User with Name and ID, Mentions with Name and ID, Retweet profile with Name and ID, timestamp
